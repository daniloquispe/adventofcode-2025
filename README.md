...
Here are my full solutions for [Advent of Code 2025](https://adventofcode.com/2025) puzzles.
...
Starting this year (2025), there will be 12 days of puzzles each December.

## About the puzzle solutions

My intention is to use [PHP](https://www.php.net/) to solve all the puzzles.

Each daily solution is a set of PHP files inside a `day-XX` directory (with `XX` from 01 to 12). Each directory has a
`puzzle.md` file with the puzzle description (from Advent of Code website) and two PHP files with names `solution-1.php`
and `solution-2.php` for both parts 1 and 2 of the puzzle.

You can run any solution file via **PHP CLI** (no web browser needed), for example:

```shell
/usr/bin/php ./day-01/solution-2.php
```
